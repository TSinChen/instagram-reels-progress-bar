 ...
 *
 * `all: initial` also blocks inherited properties such as Instagram global font stack.
 * The host own positioning is inline, which outranks this, and per spec `all` leaves
